...
Out [2026 _Winter Blast_ Adult League]({% link _pages/adult/2026.md %}) is done!
...
friends.  2026 was its first season.

The season runs for 8 weeks, starting in early January, with games on Saturdays.

Teams are 10-15+ players, coed, strictly 18 and over. Sign up with friends, make your own
team, or we'll be happy to place you on one. Teams should be big enough that players can
...
* Adjust competition size as appropriate for player availability, skill, and fitness:
  play 7v7, 8v8, or 9v9, but smaller-sided games are better on that field.
...
* _Cleats without a toe cleat_ are required. Metal cleats are not permitted.
...
Each week's open game will be hosted by a different team, whoever
has the scheduled Bye.  Players from any team are eligible to hop
