...
based on age group. For a friendly overview, see [Laws of the Game Made
Easy](/files/laws-of-the-game-made-easy-2011.pdf).

Referees: [Ref Training]({% link _pages/ref-training.md %}) covers how to apply
these rules in each division.
...
Handbook](https://cysadistrict7.org/for-coaches/playing-program-handbook/).
{: .notice--info }
...
Rules are introduced as players move up:
...
<details markdown="1">
<summary>The full CYSA heading policy</summary>
...
* Borrow just enough players to fill your field positions, but not enough
  ...
  (see **Min players** in the [division table](#divisions-at-a-glance)).
