...
All of our coaches are volunteers. Many come back year after year, but we always
welcome new ones &mdash; first-time parent volunteers and leaders with experience
elsewhere both have something valuable to bring.
...
Reach out to the [area rep](/contact/) for your school, then follow the
[Coach Registration Guide]({% link _pages/coachreg.md %}). It walks through
registering in GotSport, the two required courses, the background check, and the
Live Scan, with screenshots for each.

Anyone who spends significant time with our players needs to register &mdash; not
just head coaches, but assistant coaches and regular parent helpers too.
...
Section _4:04_ of the [MAYSL Constitution](/files/maysl-by-laws.pdf) covers
**Player Development**:

_4:04:01_ Each player must participate a minimum of 50% of every game. Applies to
all age groups and teams.

_4:04:02_ For U8 and U10 teams, each player must play each field position at least
...
are used. See [Rules](/rules/) for how we adapt them by age group.
...
That off-color line halfway between the center and penalty lines marks the
offside line for younger players. It gets them thinking about field position in a
way that creates fairer team play for both the offense and defense.

<details markdown="1">
<summary>How US Soccer describes build-out lines</summary>

From [Five Things to Know: How Small-Sided Standards Will Change Youth
Soccer](https://www.ussoccer.com/stories/2017/08/five-things-to-know-how-smallsided-standards-will-change-youth-soccer)
(they introduce them at U9; we don't run U9, so we start at U10):
...
## Divisions and League Age

Parents will ask you which team their kid lands on. As of the 2026/27 season, Cal
North sets league age by **how old a player is on Aug 1 of the season's starting
year**, which lines it up roughly with school years.

For a worked example and the age chart, see [our league age
post]({% post_url 2026-04-28-2026-league-ages %}). The division breakdown is on
the [Parent Guide]({% link _pages/parents.md %}#which-division-will-my-child-play-in),
and [US Soccer's age group
calculator](https://www.ussoccer.com/ecosystem-review/player-registration/age-group-calculator)
will work it out from a birth date.


## Practices

At the start of each season, your [area rep](/contact/) coordinates fields and
times with all of their coaches. Practices are mid-week. Many U4-U6 teams only
practice at the beginning of the season; U8 often practices once a week, and U10
and up typically twice.


## Guest Players

Yes, you can borrow players for both recreational and travel games. CYSA District
7 outlines the essentials in their [Playing Program
Handbook](https://cysadistrict7.org/for-coaches/playing-program-handbook/), and
our [rules on guest players](/rules/#guest-players--team-size) cover when to
borrow, who's eligible, and who has to approve it.
